...
namespace offsets {
	namespace game {
		constexpr auto OFFSET_GWORLD = 0xab9f1a8;
		constexpr auto OFFSET_GOBJECTS = 0xb031548;
		constexpr auto OFFSET_GNAMES = 0xb017140;
		constexpr auto OFFSET_FNAME_ENCRYPTION_KEY = 0xB016D88;
